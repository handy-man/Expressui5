...
sap.ui.define([
		...
		return BaseController.extend("ui5expresstemplate.masterdetail.controller.Master", {
			...
			onOpenViewSettings : function () {
				if (!this._oViewSettingsDialog) {
					this._oViewSettingsDialog = sap.ui.xmlfragment("ui5expresstemplate.masterdetail.view.ViewSettingsDialog", this);
